...
def manage_vendor_requests(request):
    ...
    return render(request, 'mainApp/manage_vendor_requests.html')

@user_passes_test(lambda u: u.is_superuser)
def vendor_request_detail(request, vendor_id):
    """Render the Vendor Request Detail HTML page"""
    return render(request, 'mainApp/vendor_request_detail.html', {'vendor_id': vendor_id})

@user_passes_test(lambda u: u.is_superuser)
def approve_vendor(request, vendor_id):
    """Handle Vendor Approval and redirect to request detail page"""
    # Logic to approve vendor would go here
    return render(request, 'mainApp/vendor_request_detail.html', {'vendor_id': vendor_id, 'message': 'Vendor Approved'})
...
def reject_vendor(request, vendor_id):
    ...
    return render(request, 'mainApp/vendor_request_detail.html', {'vendor_id': vendor_id, 'message': 'Vendor Rejected'})

@user_passes_test(lambda u: u.is_superuser)
def manage_vendors(request):
    """Render the Vendor Management HTML page"""
    return render(request, 'mainApp/manage_vendors.html')

@user_passes_test(lambda u: u.is_superuser)
def vendor_detail(request, vendor_id):
    """Render the Vendor Detail HTML page"""
    return render(request, 'mainApp/vendor_detail.html', {'vendor_id': vendor_id})
...
def block_vendor(request, vendor_id):
    ...
    return render(request, 'mainApp/vendor_detail.html', {'vendor_id': vendor_id, 'message': 'Vendor Blocked'})
...
def unblock_vendor(request, vendor_id):
    ...
    return render(request, 'mainApp/vendor_detail.html', {'vendor_id': vendor_id, 'message': 'Vendor Unblocked'})

@user_passes_test(lambda u: u.is_superuser)
def manage_products(request):
    """Render the Product Management HTML page"""
    return render(request, 'mainApp/manage_products.html')

@user_passes_test(lambda u: u.is_superuser)
def product_detail(request, product_id):
    """Render the Product Detail HTML page"""
    return render(request, 'mainApp/product_detail.html', {'product_id': product_id})
...
def block_product(request, product_id):
    ...
    return render(request, 'mainApp/product_detail.html', {'product_id': product_id, 'message': 'Product Blocked'})
...
def unblock_product(request, product_id):
    ...
    return render(request, 'mainApp/product_detail.html', {'product_id': product_id, 'message': 'Product Unblocked'})
